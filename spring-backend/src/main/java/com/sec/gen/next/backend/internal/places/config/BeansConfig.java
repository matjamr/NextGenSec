package com.sec.gen.next.backend.internal.places.config;
...
import com.sec.gen.next.backend.internal.places.builder.PlacesDispatcher;
...
import com.sec.gen.next.backend.internal.places.builder.add.PlacesToDbBuilder;
import com.sec.gen.next.backend.internal.places.builder.common.DynamicStatusUpdater;
import com.sec.gen.next.backend.internal.places.builder.get.GetPlacesConsumer;
import com.sec.gen.next.backend.internal.places.builder.put.*;
import com.sec.gen.next.backend.internal.places.repository.PlacesRepository;
import com.sec.gen.next.backend.internal.places.validator.PlaceAddressValidator;
import com.sec.gen.next.backend.internal.places.validator.PlaceExistenceValidator;
...
import com.sec.gen.next.backend.internal.common.address.AddressRepository;
import com.sec.gen.next.backend.internal.common.address.AddressToDbBuilder;
import com.sec.gen.next.backend.internal.common.address.validator.AddressValidator;
...
public class BeansConfig {
    ...
    public Dispatcher<List<PlacesModel>, PlacesContext, RoutingEnum> placesDispatcher(
        ...
        return new PlacesDispatcher(Map.of(
                RoutingEnum.ADD, addService,
                RoutingEnum.UPDATE, updateService,
                RoutingEnum.GET, getService,
                RoutingEnum.DELETE, deleteService
        ));
    }
