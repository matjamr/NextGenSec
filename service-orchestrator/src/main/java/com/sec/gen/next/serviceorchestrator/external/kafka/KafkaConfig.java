...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic asyncHistoryNotif() {
        return TopicBuilder.name("async-history-notif")
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic chatService() {
        return TopicBuilder.name("chat-service")
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic kafkaHistoryNotif() {
        return TopicBuilder.name("kafka-history-notif")
                .partitions(1)
                .replicas(1)
                .build();
    }
